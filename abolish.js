                ...
                for (const validatorName of Object.keys(ruleData)) {
                    ...
                    if (isAsync) {
                        ...
                        if (validationResult instanceof AbolishError_1.default) {
                             ...
                             */
                            let message = ($error ? $error : validator.error).replace(':param', $name ? $name : Functions_1.StartCase(rule));
...
},{"./AbolishError":4,"./Functions":5,"./GlobalValidators":6,"./ObjectModifier":7,"./StringToRules":8}],4:[function(require,module,exports){
"use strict";
/**
 * AbolishError
 * @class
...
},{"./Functions":5,"lodash.has":9,"lodash.unset":10}],8:[function(require,module,exports){
"use strict";
/**
 * Find key or !key
 * @type {RegExp}
